...
Written for [<highlink>Schallfeld Ensemble</highlink>][schallfeld] with the support of [<highlink>StAiR (Styria Artist in Residence) Fellowship 2022</highlink>][stair-2022].<br>
