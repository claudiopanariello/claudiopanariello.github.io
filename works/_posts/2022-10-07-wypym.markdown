...
This project is a long–term collaboration with the clarinetist [<highlink>Chiara Percivati</highlink>][percivati]. The collaboration started in 2020 as part of the project [<highlink>Different Tubes</highlink>][tubes], aimed at investigating clarinet preparation, in its widest sense, through collaborative practice. 
...
More details regarding the hardware and software implementation can be found in the [<highlink>paper</highlink>][nime_paper] we published in the the NIME Conference 2023.
